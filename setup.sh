...
# Symlink swayidle launcher to sway-config scripts directory
mkdir -p "$CONFIG_DIR/sway-config/scripts"
backup_if_exists "$CONFIG_DIR/sway-config/scripts/launch-swayidle.sh"
...
echo ""
echo "3. Install fonts for proper theme display:"
echo "   sudo pacman -S ttf-meslo-nerd ttf-dejavu noto-fonts noto-fonts-emoji cantarell-fonts"
echo ""
echo "4. Log out and select 'BunkerOS' from your display manager"
